...
class Respawn():
    def __init__(self):
        ...
        self.modelPath = self.modelPath.replace('/home/wanbaoliang/DRL3_ws/src/DDPG','/home/wanbaoliang/DRL3_ws/src/DDPG/model.sdf')
        self.f = open(self.modelPath, 'r')
        self.model = self.f.read()
        self.stage = 4
        #rospy.get_param('/stage_number')
        self.goal_position = Pose()
        self.init_goal_x = 0.4
        self.init_goal_y = 0.4
