...
class DQN(object):
    def __init__(self):                                                         # 定义DQN的一系列属性
        ...
        self.load_models=False  # 没有model文件夹，要设为False
        self.load_ep =780
        self.loss =0
        self.q_eval=0
        self.q_target=0
        if self.load_models:
            ...
            checkpoint = torch.load("/home/wanbaoliang/DRL3_ws/src/DQN/model/"+str(self.load_ep)+"a.pt")
    ...
    def save_model(self,dir):
        ...
        torch.save(state,"/home/wanbaoliang/DRL3_ws/src/DQN/model/"+ dir+"a.pt")
