...
class Agent:
    ...
    def __init__(self):    
        ...
        # torch.load是加载模型（.pth)  torch.load_state_dict是加载模型参数
        #self.pi.load_state_dict(torch.load("/home/jm-kim/catkin_ws/src/myrobot/src/SAC/saved_model/1225/sac_actor_1225_EP662.pt"))
        self.pi.load_state_dict(torch.load("/home/wanbaoliang/DRL2_ws/src/myrobot/src/SAC/saved_model/1223_1/sac_actor_1223_1_EP388.pt"))
